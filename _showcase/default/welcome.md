...
<div class="p-4">
    ...
    <hr />
    <p>
        Welcome to the <a href="{{ '/real-world.html' | relative_url }}">real world</a>. <code>Showcase</code> is a page where you can show off almost anything you want. It can be the photo of your pets, your favorite books, your favorite projects, or anything else you want to show to the world.
    </p>
    <p>
